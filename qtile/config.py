...
keys = [
    ...
    Key([mod, "control"], "Left", lazy.screen.prev_group(), desc="Prev screen"),
    Key([mod, "control"], "Right", lazy.screen.next_group(), desc="Next screen"),
    ...
    # Audio control (polybar IPC)
    Key([], "XF86AudioRaiseVolume", lazy.spawn('polybar-msg action "#pulseaudio.inc"'), desc="Raise volume"),
    Key([], "XF86AudioLowerVolume", lazy.spawn('polybar-msg action "#pulseaudio.dec"'), desc="Lower volume"),
    Key([], "XF86AudioMute",        lazy.spawn('polybar-msg action "#pulseaudio.toggle"'), desc="Mute/unmute"),
#    Key([], "XF86AudioMicMute",     lazy.spawn(TBD)),
